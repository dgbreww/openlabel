								...
								<td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
									...
									<div style="text-align:center; margin:0 15px 34px 15px">
										...
										<div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                                            ...
                                            <p style="margin-bottom:2px; color:#7E8299">We're sending you this email because your password has been changed successfully. </p>
                                            <p style="margin-bottom:2px; color:#7E8299">If you have not changed it, please reset the password on click the given button.</p>
                                            <!--begin:Action-->
										<a href="{{ url('admin/reset-password'); }}" target="_blank" style="background-color:#50cd89; border-radius:6px;display:inline-block; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; font-family:Arial,Helvetica,sans-serif;">Change Password</a>
										<!--end:Action-->
                                        </div>
									</div>
									<!--end:Email content-->
