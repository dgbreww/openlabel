								...
								<td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
									...
									<div style="text-align:center; margin:0 15px 34px 15px">
										...
										<div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                                            ...
                                            <p style="margin-bottom:2px; color:#7E8299">We're sending you this email because your email has been changed successfully. </p>
                                            <p style="margin-bottom:2px; color:#7E8299">If you have not changed it, Please contact to Admin.</p>
                                            <!--begin:Action-->
										<!--end:Action-->
                                        </div>
									</div>
