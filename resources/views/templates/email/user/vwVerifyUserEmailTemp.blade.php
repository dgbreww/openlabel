								...
								<td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
									...
									<div style="text-align:center; margin:0 15px 34px 15px">
										...
										<div style="margin-bottom: 15px">
											<img alt="Logo" src="{{ asset('public/admin/') }}/media/email/icon-positive-vote-1.svg" />
										</div>
										<!--end:Media-->
										<!--begin:Text-->
										<div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                                            <p style="margin-bottom:9px; color:#181C32; font-size: 22px; font-weight:700">Hey {{ $first_name }}</p>
                                            <p style="margin-bottom:2px; color:#7E8299">Please click on the button to verify your email</p>
                                            <p style="margin-bottom:6px; color:#7E8299">If you have not tried to register, ignore this message.</p>
                                            <a href="{{ url('/verify/'.$token) }}" target="_blank" style="background-color:#50cd89; border-radius:6px;display:inline-block; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; font-family:Arial,Helvetica,sans-serif;">Click to Verify</a>
                                        </div>
									</div>
									<!--end:Email content-->
								</td>
