					...
					<div class="card mb-5 mb-xl-10">
						...
						<div class="card-header border-0 cursor-pointer">
							...
							<div class="card-title m-0">
								<h3 class="fw-bold m-0">Add Package</h3>
							</div>
							<!--end::Card title-->
						...
						<div id="kt_account_settings_profile_details" class="collapse show">
							<!--begin::Form-->
							<form action="{{ url('admin/packages/doAdd') }}" id="kt_add_packages_form" class="form" enctype="multipart/form-data" method="post">
								<!--begin::Card body-->
								<div class="card-body border-top p-9">
									...
									<div class="row mb-6">
										...
										<div class="col-lg-8">
											<div class="row">
												<div class="col-lg-12 fv-row">
													<input type="text" name="packageName" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Package Name" value="" />
									...
									<div class="row mb-6">
										...
										<div class="col-lg-8">
											<div class="row">
												<div class="col-lg-12 fv-row">
													<input min="1" type="number" name="noOfVideos" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="No of Videos" value="" />
									...
									<div class="row mb-6">
										...
										<div class="col-lg-8">
											<div class="row">
												<div class="col-lg-12 fv-row">
													<input min="1" type="number" name="noOfVideosReceived" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="No of Videos Received" value="" />
									...
									<div class="row mb-6">
										...
										<div class="col-lg-8">
											<div class="row">
												<div class="col-lg-12 fv-row">
													<input min="1" type="number" name="timeline" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Timeline" value="" />
									...
									<div class="row mb-6">
										...
										<div class="col-lg-8">
											<div class="row">
												<div class="col-lg-12 fv-row">
													<input min="1" type="number" name="price" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Price" value="" />
								...
								<div class="card-footer d-flex justify-content-end py-6 px-9">
									@csrf
									<button type="submit" class="btn btn-primary" id="kt_add_packages_form_submit">
