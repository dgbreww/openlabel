						...
						<div class="card-header pt-8">
							<div class="card-title">
								...
								<div class="d-flex align-items-center position-relative my-1">
									...
									<!--end::Svg Icon-->
									<input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Video Size" />
								</div>
								<!--end::Search-->
							</div>
							<!--begin::Card toolbar-->
							<div class="card-toolbar">
								...
								<div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
									<a href="{{ url('/admin/video-size/add') }}" class="btn btn-primary">Add Video Size</a>
								</div>
								<!--end::Toolbar-->
								<!--begin::Group actions-->
							...
							<table id="kt_file_manager_list" data-kt-filemanager-table="folders" class="table align-middle table-row-dashed fs-6 gy-5">
								...
								<thead>
									...
									<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
										...
										<th class="min-w-250px">Video Width</th>
										<th class="min-w-250px">Video Height</th>
