			...
			<div id="kt_header" class="header">
				...
				<div class="container-fluid d-flex align-items-center flex-wrap justify-content-between" id="kt_header_container">
					...
					<div class="d-flex align-items-center flex-shrink-0">
								...
								<div data-kt-search-element="wrapper">
									...
									<div data-kt-search-element="results" class="d-none">
										...
										<div class="scroll-y mh-200px mh-lg-350px">
											...
											<!--end::Category title-->
											<!--begin::Item-->
											<a href="settings.html#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
												<!--begin::Symbol-->
									...
									<div class="" data-kt-search-element="main">
										...
										<div class="scroll-y mh-200px mh-lg-325px">
											...
											<div class="d-flex align-items-center mb-5">
												...
												<!--begin::Title-->
												<div class="d-flex flex-column">
													<a href="settings.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">BoomApp by Keenthemes</a>
											...
											<div class="d-flex align-items-center mb-5">
												...
												<!--begin::Title-->
												<div class="d-flex flex-column">
													<a href="settings.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"Kept API Project Meeting</a>
											...
											<div class="d-flex align-items-center mb-5">
												...
												<!--begin::Title-->
												<div class="d-flex flex-column">
													<a href="settings.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"KPI Monitoring App Launch</a>
											...
											<div class="d-flex align-items-center mb-5">
												...
												<!--begin::Title-->
												<div class="d-flex flex-column">
													<a href="settings.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">Project Reference FAQ</a>
											...
											<div class="d-flex align-items-center mb-5">
												...
												<!--begin::Title-->
												<div class="d-flex flex-column">
													<a href="settings.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"FitPro App Development</a>
													<span class="fs-7 text-muted fw-semibold">#84250</span>
												</div>
												<!--end::Title-->
											</div>
											...
											<div class="d-flex align-items-center mb-5">
												...
												<!--begin::Title-->
												<div class="d-flex flex-column">
													<a href="settings.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">Shopix Mobile App</a>
											...
											<div class="d-flex align-items-center mb-5">
												...
												<!--begin::Title-->
												<div class="d-flex flex-column">
													<a href="settings.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"Landing UI Design" Launch</a>
						...
						<div class="d-flex align-items-center ms-3 ms-lg-4">
							<!--begin::Menu toggle-->
							<a href="settings.html#" class="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline w-40px h-40px" data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
							...
							<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px" data-kt-menu="true" data-kt-element="theme-mode-menu">
								...
								<div class="menu-item px-3 my-0">
									<a href="settings.html#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="light">
								...
								<!--begin::Menu item-->
								<div class="menu-item px-3 my-0">
									<a href="settings.html#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="dark">
										<span class="menu-icon" data-kt-element="icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen061.svg-->
											<span class="svg-icon svg-icon-3">
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<!--begin::Menu item-->
								<div class="menu-item px-3 my-0">
									<a href="settings.html#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="system">
										<span class="menu-icon" data-kt-element="icon">
					...
					<div class="card mb-5 mb-xl-10">
						...
						<div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
							...
							<ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
								...
								<!--begin:::Tab item-->
								<li class="nav-item">
									<a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="view.html#kt_customer_view_overview_events_and_logs_tab">Events & Logs</a>
								</li>
								<!--end:::Tab item-->
								<!--begin:::Tab item-->
								<li class="nav-item">
									<a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab" href="view.html#kt_customer_view_overview_statements">Statements</a>
								</li>
								<!--end:::Tab item-->
							</ul>
										...
										<div class="card-body border-top p-9">
											...
											<div class="row mb-6">
												...
												<div class="col-lg-8">
													...
													<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ asset('public/admin/') }}/media/svg/avatars/blank.svg')">
														...
														<div id="preview_adminLogo" class="image-input-wrapper w-125px h-125px" style="background-image: url({{ $profileImage  }})"></div>
														...
														<label class="image-picker btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-input-name="adminLogo" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change Admin Logo">
															...
															<input id="input_adminLogo" type="hidden" name="adminLogo" value="{{ $siteSettingData->admin_logo }}">
														</label>
											...
											<div class="row mb-6">
												...
												<div class="col-lg-8">
													...
													<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ asset('public/admin/') }}/media/svg/avatars/blank.svg')">
														...
														<!--begin::Preview existing avatar-->
														<div id="preview_websiteLogo" class="image-input-wrapper w-125px h-125px" style="background-image: url({{ $profileImage  }})"></div>
														<!--end::Preview existing avatar-->
														...
														<label class="image-picker btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-input-name="websiteLogo" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change Website Logo">
															<i class="bi bi-pencil-fill fs-7"></i>
															<input id="input_websiteLogo" type="hidden" name="websiteLogo" value="{{ $siteSettingData->website_logo }}">
														</label>
											...
											<div class="row mb-6">
												...
												<div class="col-lg-8">
													...
													<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ asset('public/admin/') }}/media/svg/avatars/blank.svg')">
														...
														<!--begin::Preview existing avatar-->
														<div id="preview_adminLoginBackground" class="image-input-wrapper w-125px h-125px" style="background-image: url({{ $profileImage  }})"></div>
														<!--end::Preview existing avatar-->
														...
														<label class="image-picker btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-input-name="adminLoginBackground" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change Admin Login Background">
															<i class="bi bi-pencil-fill fs-7"></i>
															<input id="input_adminLoginBackground" type="hidden" name="adminLoginBackground" value="{{ $siteSettingData->login_background_img }}">
														</label>
														...
														<!--begin::Remove-->
														<span id="remove_adminLoginBackground" class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-input-name="websiteLogo" data-kt-image-input-action="remove" data-input-name="websiteLogo" data-bs-toggle="tooltip" title="Remove Admin Login Background">
															<i class="bi bi-x fs-2"></i>
														</span>
														<!--end::Remove-->
													</div>
												...
												<div class="col-lg-8">													
													<div class="row">
														<div class="col-lg-12 fv-row">
															<input type="text" name="websiteName" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Website Name" value="{{ $siteSettingData->website_name }}" />
											...
											<div class="row mb-6">
												...
												<div class="col-lg-8">													
													<div class="row">
														<div class="col-lg-12 fv-row">
															<input type="text" name="websiteEmail" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Website Email" value="{{ $siteSettingData->website_email }}" />
											...
											<div class="row mb-6">
												...
												<div class="col-lg-8 fv-row">
													<input type="tel" name="websitePhoneNumber" class="form-control form-control-lg form-control-solid" placeholder="Website Phone Number" value="{{ $siteSettingData->website_phone }}" />
											...
											<div class="row mb-6">
												...
												<div class="col-lg-8 fv-row">
													<input type="text" name="websiteAddress" class="form-control form-control-lg form-control-solid" placeholder="Website Address" value="{{ $siteSettingData->website_address }}" />
											...
											<div class="row mb-6">
												...
												<div class="col-lg-8">													
													<div class="row">
														<div class="col-lg-12 fv-row">
															<input type="text" name="copyright" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Copyright" value="{{ $siteSettingData->copyright }}" />
												...
												<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_customers_logs">
													...
													<tbody>
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoice/in_3575_1585/invalid</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoice/in_4985_5651/invalid</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/customer/c_63b699f248c52/not_found</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoices/in_7221_3697/payment</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoices/in_5920_1558/payment</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/customer/c_63b699f248c4e/not_found</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoices/in_2583_4217/payment</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
											...
											<div class="card-toolbar">
												...
												<ul class="nav nav-stretch fs-5 fw-semibold nav-line-tabs nav-line-tabs-2x border-transparent" role="tablist">
													<li class="nav-item" role="presentation">
														<a class="nav-link text-active-primary active" data-bs-toggle="tab" role="tab" href="view.html#kt_customer_view_statement_1">This Year</a>
													</li>
													<li class="nav-item" role="presentation">
														<a class="nav-link text-active-primary ms-3" data-bs-toggle="tab" role="tab" href="view.html#kt_customer_view_statement_2">2020</a>
													</li>
													<li class="nav-item" role="presentation">
														<a class="nav-link text-active-primary ms-3" data-bs-toggle="tab" role="tab" href="view.html#kt_customer_view_statement_3">2019</a>
													</li>
													<li class="nav-item" role="presentation">
														<a class="nav-link text-active-primary ms-3" data-bs-toggle="tab" role="tab" href="view.html#kt_customer_view_statement_4">2018</a>
													</li>
												</ul>
												<!--end::Tab nav-->
											</div>
													...
													<table id="kt_customer_view_statement_table_1" class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-4">
														...
														<tbody>
															<tr>
																<td>Nov 01, 2021</td>
																<td>
																	<a href="view.html#" class="text-gray-600 text-hover-primary">102445788</a>
																</td>
															...
															<tr>
																<td>Oct 24, 2021</td>
																<td>
																	<a href="view.html#" class="text-gray-600 text-hover-primary">423445721</a>
																</td>
																<td>Seller Fee</td>
															...
															<tr>
																<td>Oct 08, 2021</td>
																<td>
																	<a href="view.html#" class="text-gray-600 text-hover-primary">312445984</a>
																</td>
															...
															<tr>
																<td>May 30, 2021</td>
																<td>
																	<a href="view.html#" class="text-gray-600 text-hover-primary">523445943</a>
																</td>
																<td>Seller Fee</td>
															...
															<tr>
																<td>Apr 22, 2021</td>
																<td>
																	<a href="view.html#" class="text-gray-600 text-hover-primary">231445943</a>
																</td>
															...
															<tr>
																<td>Feb 09, 2021</td>
																<td>
																	<a href="view.html#" class="text-gray-600 text-hover-primary">426445943</a>
																</td>
															...
															<tr>
																<td>Nov 01, 2021</td>
																<td>
																	<a href="view.html#" class="text-gray-600 text-hover-primary">984445943</a>
																</td>
															...
															<tr>
																<td>Jan 04, 2021</td>
																<td>
																	<a href="view.html#" class="text-gray-600 text-hover-primary">324442313</a>
																</td>
																<td>Seller Fee</td>
