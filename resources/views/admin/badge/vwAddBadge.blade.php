					...
					<div class="card mb-5 mb-xl-10">
						...
						<div class="card-header border-0 cursor-pointer">
							...
							<div class="card-title m-0">
								<h3 class="fw-bold m-0">Add Badge</h3>
							</div>
							<!--end::Card title-->
						...
						<div id="kt_account_settings_profile_details" class="collapse show">
							<!--begin::Form-->
							<form action="{{ url('admin/badge/doAdd') }}" id="kt_add_badge_form" class="form" enctype="multipart/form-data" method="post">
								<!--begin::Card body-->
										...
										<div class="col-lg-8">
											...
											<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ asset('public/admin/') }}/media/svg/avatars/blank.svg')">
												...
												<label class="image-picker btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-input-name="image" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
													...
													<input id="input_image" type="hidden" name="image" value="">
													<!--end::Inputs-->
												</label>
												<!--end::Label-->
								...
								<div class="card-footer d-flex justify-content-end py-6 px-9">
									@csrf
									<button type="submit" class="btn btn-primary" id="kt_add_badge_form_submit">
