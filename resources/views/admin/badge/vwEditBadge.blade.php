					...
					<div class="card mb-5 mb-xl-10">
						...
						<div class="card-header border-0 cursor-pointer">
							...
							<div class="card-title m-0">
								<h3 class="fw-bold m-0">Edit Badge</h3>
							</div>
							<!--end::Card title-->
							...
							<div class="card-toolbar">
								...
								<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
									<!--begin::Add customer-->
									<a href="{{ url('/admin/badge'); }}" class="btn btn-primary">Back</a>
									<!--end::Add customer-->
								</div>
								<!--end::Toolbar-->
							</div>
						...
						<div id="kt_account_settings_profile_details" class="collapse show">
							<!--begin::Form-->
							<form action="{{ url('admin/badge/doUpdate') }}" id="kt_update_badge_form" class="form" enctype="multipart/form-data" method="post">
								<!--begin::Card body-->
										...
										<div class="col-lg-8">
											...
											<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ asset('public/admin/') }}/media/svg/avatars/blank.svg')">
												...
												<label class="image-picker btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-input-name="image" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
													...
													<input id="input_image" type="hidden" name="image" value="{{ $badgeData->badge_img }}">
													<!--end::Inputs-->
												</label>
												<!--end::Label-->
										...
										<div class="col-lg-8">
											...
											<div class="row">
												...
												<div class="col-lg-12 fv-row">
													<input type="text" name="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Name" value="{{ $badgeData->badge_name }}" />
									...
									<div class="row mb-6">
										...
										<div class="col-lg-8">
											...
											<div class="row">
												<!--begin::Col-->
												<div class="col-lg-12 fv-row">
													<input min="1" type="number" name="displayOrder" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Display Order" value="{{ $badgeData->display_order }}" />
								...
								<div class="card-footer d-flex justify-content-end py-6 px-9">
									<input type="hidden" name="id" value="{{ $badgeData->id }}">
									@csrf
									<button type="submit" class="btn btn-primary" id="kt_update_badge_form_submit">
