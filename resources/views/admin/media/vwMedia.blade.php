			...
			<div id="kt_header" class="header">
				...
				<div class="container-fluid d-flex align-items-center flex-wrap justify-content-between" id="kt_header_container">
					...
					<div class="d-flex align-items-center flex-shrink-0">
								...
								<div data-kt-search-element="wrapper">
									...
									<div data-kt-search-element="results" class="d-none">
										...
										<div class="scroll-y mh-200px mh-lg-350px">
											...
											<!--end::Category title-->
											<!--begin::Item-->
											<a href="folders.html#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
												<!--begin::Symbol-->
									...
									<div class="" data-kt-search-element="main">
										...
										<div class="scroll-y mh-200px mh-lg-325px">
											...
											<div class="d-flex align-items-center mb-5">
												...
												<!--begin::Title-->
												<div class="d-flex flex-column">
													<a href="folders.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">BoomApp by Keenthemes</a>
											...
											<div class="d-flex align-items-center mb-5">
												...
												<!--begin::Title-->
												<div class="d-flex flex-column">
													<a href="folders.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"Kept API Project Meeting</a>
											...
											<div class="d-flex align-items-center mb-5">
												...
												<!--begin::Title-->
												<div class="d-flex flex-column">
													<a href="folders.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"KPI Monitoring App Launch</a>
											...
											<div class="d-flex align-items-center mb-5">
												...
												<!--begin::Title-->
												<div class="d-flex flex-column">
													<a href="folders.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">Project Reference FAQ</a>
											...
											<div class="d-flex align-items-center mb-5">
												...
												<!--begin::Title-->
												<div class="d-flex flex-column">
													<a href="folders.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"FitPro App Development</a>
													<span class="fs-7 text-muted fw-semibold">#84250</span>
												</div>
												<!--end::Title-->
											</div>
											...
											<div class="d-flex align-items-center mb-5">
												...
												<!--begin::Title-->
												<div class="d-flex flex-column">
													<a href="folders.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">Shopix Mobile App</a>
											...
											<div class="d-flex align-items-center mb-5">
												...
												<!--begin::Title-->
												<div class="d-flex flex-column">
													<a href="folders.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"Landing UI Design" Launch</a>
						...
						<div class="d-flex align-items-center ms-3 ms-lg-4">
							<!--begin::Menu toggle-->
							<a href="folders.html#" class="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline w-40px h-40px" data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
							...
							<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px" data-kt-menu="true" data-kt-element="theme-mode-menu">
								...
								<div class="menu-item px-3 my-0">
									<a href="folders.html#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="light">
								...
								<!--begin::Menu item-->
								<div class="menu-item px-3 my-0">
									<a href="folders.html#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="dark">
										<span class="menu-icon" data-kt-element="icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen061.svg-->
											<span class="svg-icon svg-icon-3">
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<!--begin::Menu item-->
								<div class="menu-item px-3 my-0">
									<a href="folders.html#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="system">
										<span class="menu-icon" data-kt-element="icon">
