				...
				<div class="container-fluid" id="kt_content_container">
					...
					<div class="card mb-5 mb-xl-10">
						...
						<div id="kt_account_settings_profile_details" class="collapse show">
							<!--begin::Form-->
							<form action="{{ url('admin/genre/doAdd') }}" id="kt_add_genre_form" class="form" enctype="multipart/form-data" method="post">
								<!--begin::Card body-->
										...
										<div class="col-lg-8">
											<div class="row">
												<div class="col-lg-12 fv-row">
													<input type="text" name="genreName" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Genre Name" value="" />
								...
								<div class="card-footer d-flex justify-content-end py-6 px-9">
									@csrf
									<button type="submit" class="btn btn-primary" id="kt_add_genre_form_submit">
