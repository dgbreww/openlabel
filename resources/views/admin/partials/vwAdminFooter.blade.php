...
<div class="modal fade" id="kt_modal_image_picker" tabindex="-1" aria-hidden="true">
	<!--begin::Modal dialog-->
	<div class="modal-dialog modal-dialog-centered mw-75">
		...
		<div class="modal-content">
			...
			<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
				...
				<div class="card card-flush">
					...
					<div class="card-header pt-8">
						...
						<div class="card-toolbar">
							<!--begin::Toolbar-->
							<div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
								<button style="display:none" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_upload">
					...
					<div class="card-body">
						...
						<div class="d-flex flex-stack">
							...
							<div class="badge badge-lg badge-primary">
								<span id="kt_image_picker_items_counter">0 items</span>
							</div>
							<!--end::Folder Stats-->
						</div>
						<!--end::Table header-->
						<!--begin::Table-->
						<table id="kt_image_picker_list" data-kt-filemanager-table="folders" class="table align-middle table-row-dashed fs-6 gy-5">
							<!--begin::Table head-->
							<thead>
								<!--begin::Table row-->
								<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
									<th class="w-10px pe-2">
										<div class="form-check form-check-sm form-check-custom form-check-solid me-3">
											<input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_image_picker_list .form-check-input" value="1" />
										</div>
									</th>
				...
				<table class="d-none">
					<tr id="kt_image_picker_new_folder_row" data-kt-filemanager-template="upload">
						<td></td>
						<td id="kt_image_picker_add_folder_form" class="fv-row">
							<div class="d-flex align-items-center">
								...
								<!--end:Input-->
								<!--begin:Submit button-->
								<button class="btn btn-icon btn-light-primary me-3" id="kt_image_picker_add_folder">
								...
								<!--end:Submit button-->
								<!--begin:Cancel button-->
								<button class="btn btn-icon btn-light-danger" id="kt_image_picker_cancel_folder">
									<span class="indicator-label">
...
<!--begin::Javascript-->
<script>
	var hostUrl = "{{ asset('public/admin/') }}/";
