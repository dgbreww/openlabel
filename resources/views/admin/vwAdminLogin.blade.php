...
<html lang="en">
	<!--begin::Head-->
	<head>
		<title>{{ $siteSettings->website_name }} | Login</title>
		<meta charset="utf-8" />
				...
				<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
					...
					<div class="d-flex flex-center flex-column flex-lg-row-fluid">
						...
						<div class="w-lg-500px p-10">
							<!--begin::Form-->
							<form class="form w-100" id="kt_sign_in_form" action="{{ url('admin/doLogin') }}">
								<!--begin::Heading-->
								...
								<div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
									<div></div>
									<!--begin::Link-->
									<a href="{{ url('admin/reset-password'); }}" class="link-primary">Forgot Password ?</a>
									<!--end::Link-->
								</div>
								<!--end::Wrapper-->
								<!--begin::Submit button-->
