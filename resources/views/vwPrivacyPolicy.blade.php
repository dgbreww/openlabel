		...
		<div class="about-tiktok-banner-inner">
			<div class="tiktok-text-sec">
				...
				<div class="how-it-works-text">
					...
					<h6>Our privacy obligations</h6>

					<p>Openlabelsuccess.com ("Open-Label") is governed by The United States of America’s  Privacy Principles that regulates how personal information is handled by Openlabelsuccess.com.</p>

					<p>'Personal information' means information or an opinion about an identified individual, or an individual who is reasonably identifiable. Open-label's Privacy Policy applies to personal information collected and/or held by Open-label.</p>
					...
					<h6>The types of personal information we collect and hold</h6>
				    ...
				    <p>Information that we collect from others. Users can give permission for us to connect to their account on other platforms to collect personal information. This includes but is not limited to Instagram, Tiktok, Facebook, LinkedIn, and Google. Information collected will be governed by this Privacy Policy. Users can stop us from collecting data from other platforms by removing our access on the other platform or by contacting our support team.</p>
				    ...
				    <p>Information we collect as you use our service. We maintain records of the interactions we have with our users, including the products, services and customer support we have provided. This includes the interactions our users have with our platform such as when a user has viewed a page or clicked a button.</p>
					...
					<p>Third party applications. Through the Open-label API it is possible for users to grant third party applications access to their Open-label account. Depending on the permissions that are granted, these applications may be able to access some personal information or do actions on the users' behalf. These third party applications are not controlled by us and will be governed by their own privacy policy. Users are able to remove third party applications from access their data through their settings.</p>

					<p>Other disclosures and transfers. We may also disclose your personal information to third parties for the following purposes:</p>
					...
					<p>As we are a US based company, with office based at Baltimore, United States, your personal information may be processed by staff in any of our offices.</p>

					<h6>Accessing, correcting, or downloading your personal information</h6>

					<p>You have the right to request access to the personal information Open-label holds about you. Unless an exception applies, we must allow you to see the personal information we hold about you, within a reasonable time period, and without unreasonable expense for no charge. Most personal information can be accessed by logging into your account. If you wish to access information that is not accessible through the platform, or wish to download all personal information we hold on you in a portable data format, please contact our Privacy Officer.</p>
					...
					<p>Human review of automated decision making / profiling - In the case of our ranking algorithms, it is not possible to exercise this right as this ranking is a fundamental part of the marketplace that users participate in, opting out would mean not being able to participate in the marketplace. Decisions affecting marketplace security are already reviewed by humans.</p>
					...
					<h6>To contact our Privacy Officer</h6>
					...
					<p><strong>Email: <a href="mailto:info@upliftworks.com">info@upliftworks.com</a> </strong> </p>
