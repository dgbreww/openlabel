...
var KTFileManagerList = function () {
    ...
    const initToggleToolbar = () => {
        ...
        if (table.getAttribute('data-kt-filemanager-table') === 'folders') {
            checkboxes = document.querySelectorAll('#kt_image_picker_list_wrapper [type="checkbox"]');
        }
    ...
    return {
        init: function () {
            table = document.querySelector('#kt_image_picker_list');
